...
from domain_types import ROI, ArucoDetectionMode, Point, VisionObjectType
from image.geometry import compute_homography_from_points, create_affine_transform, normalize_angle
from image.overlay import render_aruco_markers, render_reference_plane
