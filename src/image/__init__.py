...
- geometry: Geometric calculations (angles, contour properties, transformations)
- roi: ROI validation and extraction
- overlay: Vision detection result visualization
- colors: HSV color definitions and color detection utilities
- test_patterns: Test image generation
- transform: Image transformation utilities
...
# Converter functions
from .converters import encode_image_to_base64, ensure_bgr, ensure_grayscale, from_base64, to_base64

# Geometry functions
from .geometry import calculate_contour_properties, normalize_angle
...
# Processor functions
from .processors import create_thumbnail, resize_image
