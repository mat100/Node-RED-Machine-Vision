...
def create_affine_transform(origin: tuple, rotation_deg: float, scale: float) -> np.ndarray:
    """
...
def transform_point_homography(point: tuple, homography: np.ndarray) -> tuple:
    """
...
def transform_rotation_homography(
    rotation_deg: float, homography: np.ndarray, center: tuple
) -> float:
    """
...
def estimate_scale_from_homography(homography: np.ndarray) -> tuple:
    """
...
def transform_dimensions_homography(
    width: float, height: float, homography: np.ndarray, center: tuple
) -> tuple:
    """
